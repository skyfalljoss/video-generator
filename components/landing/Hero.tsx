    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white pt-20">
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          ...
          <Button size="lg" variant="outline" className="h-12 rounded-full border-zinc-200 bg-white text-base font-semibold text-zinc-900 hover:bg-zinc-50 hover:text-indigo-600">
        ...
        {/* Mock UI / Visual */}
        <div className="mt-20 relative mx-auto max-w-5xl rounded-xl border border-zinc-200 bg-white p-2 shadow-xl lg:rounded-2xl lg:p-4">
           <div className="aspect-video overflow-hidden rounded-lg bg-zinc-50 border border-zinc-100">
